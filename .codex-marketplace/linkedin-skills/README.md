...
<p align="center">
  <img src="https://img.shields.io/github/v/release/ANURAGJAMANKAR/linkedin-skills?color=1E40AF&label=release" alt="Latest release">
  ...
  <img src="https://img.shields.io/github/stars/ANURAGJAMANKAR/linkedin-skills?style=social" alt="GitHub stars">
  <img src="https://img.shields.io/badge/PRs-welcome-F59E0B.svg" alt="PRs Welcome">
  <img src="https://img.shields.io/badge/status-actively%20improving-blue" alt="Actively improving">
</p>
...
```bash
codex plugin marketplace add ANURAGJAMANKAR/linkedin-skills
...
```bash
git clone https://github.com/ANURAGJAMANKAR/linkedin-skills.git
cd linkedin-skills
...
5. Paste `ANURAGJAMANKAR/linkedin-skills` there and sync
...
4. Select **Add from a repository**, paste `ANURAGJAMANKAR/linkedin-skills`, and sync
...
```
/plugin marketplace add ANURAGJAMANKAR/linkedin-skills
...
```bash
git clone https://github.com/ANURAGJAMANKAR/linkedin-skills.git ~/.hermes/skills/linkedin-skills
```
...
```bash
npx skills add ANURAGJAMANKAR/linkedin-skills
```

> **Found this useful? [Star the repo](https://github.com/ANURAGJAMANKAR/linkedin-skills).** Curated Claude Code and Codex directories rank and gate by star count, so a star is what makes these skills findable for the next person. It is the only thing we ask. No signup, no email.
...
| **Codex CLI** | Yes | Install via `codex plugin marketplace add ANURAGJAMANKAR/linkedin-skills` and `codex plugin add linkedin-skills@linkedin-skills`. |
...
```bash
git clone git@github.com:ANURAGJAMANKAR/linkedin-skills.git
...
Built and maintained by [Anurag Jamankar](https://github.com/ANURAGJAMANKAR), with Claude.

The idea is simple: writing collapsed to the price of a chat subscription, so what stays valuable is everything underneath it — pulling every post your market wrote this week, keeping a live list of the people who matter, engaging daily with judgment in the loop, and catching the risky drafts before the platform does. This repo is that layer for LinkedIn, open-sourced and under active development.

See [CONTRIBUTORS.md](CONTRIBUTORS.md) for the full list and [CHANGELOG.md](CHANGELOG.md) for release history.
...
- [x-skills](https://github.com/ANURAGJAMANKAR/x-skills) - X (Twitter)
- [instagram-skills](https://github.com/ANURAGJAMANKAR/instagram-skills) - Instagram
- [youtube-skills](https://github.com/ANURAGJAMANKAR/youtube-skills) - YouTube
- [threads-skills](https://github.com/ANURAGJAMANKAR/threads-skills) - Threads
- [tiktok-skills](https://github.com/ANURAGJAMANKAR/tiktok-skills) - TikTok
- [facebook-skills](https://github.com/ANURAGJAMANKAR/facebook-skills) - Facebook Pages
