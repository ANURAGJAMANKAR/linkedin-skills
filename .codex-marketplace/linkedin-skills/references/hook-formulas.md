...
**2026 reach notes (audit of Sep 2026).** Every formula below carries a short "2026 reach note". The reference engagement numbers are unchanged; the notes say what the 2026 feed does to the *device* the formula leans on. Evidence tiers, cited inline:
