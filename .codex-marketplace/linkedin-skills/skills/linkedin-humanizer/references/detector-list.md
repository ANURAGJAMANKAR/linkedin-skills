...
- An internal team test (2026): scored a hand-written article **100% AI** while GPTZero scored the same article 82% and ZeroGPT scored 50%. 50-point spread on identical text.

**Citation**: Internal team test, March 2026; widely discussed in 2026 commentary on detector unreliability.
...
- **50 points** — spread observed on a single article in internal team testing (2026)
