...
- Primary author **must** be Anurag: every `git commit` needs
  `--author="Anurag Jamankar <anurag.jamankar.opp@gmail.com>"`. The harness
  defaults to the Claude identity if you forget; verify with
