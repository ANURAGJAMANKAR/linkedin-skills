...
- **Preferred:** open a private report via
  [GitHub Security Advisories](https://github.com/ANURAGJAMANKAR/linkedin-skills/security/advisories/new)
- **Alternative:** email `anurag.jamankar.opp@gmail.com` with subject `[SECURITY] linkedin-skills`
