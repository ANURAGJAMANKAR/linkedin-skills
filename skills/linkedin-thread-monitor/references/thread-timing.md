...
- 14:27 UTC: Anurag posted comment on a CEO's post ("moat moved from tools to taste")
- 12:06 UTC next day (~22h later): the author replied personally ("How are you building that conviction muscle with your team?")
- 16:24 UTC that day (~28h after original comment, ~4h after the author's reply): Anurag replied with his answer
